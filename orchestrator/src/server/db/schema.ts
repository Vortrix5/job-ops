...
export const jobs = sqliteTable(
  "jobs",
  {
    ...
    suitabilityConfidence: real("suitability_confidence"),
    suitabilityBreakdown: text("suitability_breakdown"),
    suitabilityScoringVersion: text("suitability_scoring_version"),
